...
The canonical ordered-key index for Merkle State. It provides stable state roots, structural sharing, key membership proofs, key non-membership proofs, and shared-node diffs (correct and canonical; full cursor/chunker path-copying remains P3 deferred).
