...
- `docs/COMMERCIALIZATION-IMPROVEMENT-PLAN.zh-CN.md` 中已记录的商业目标和工程约束。
- `docs/scenarios/README.md` 中确认的 8 个场景。
- `docs/scenarios/SCENARIO-IMPLEMENTATION-GAPS.md` 中的场景差距清单。
- `docs/SUBSYSTEM-REFACTOR-CHECKLIST.md`、`docs/PRODUCTION-CAPABILITY-GAP.md`、`docs/PROJECT-HYGIENE-BASELINE-2026-06-03.md` 中的架构、生产和工程卫生口径。
...
- `docs/Architecture.md`、`docs/PROTOCOLS.md`、`docs/WORKSPACE-ASSET-GOVERNANCE.md`、`docs/COMMERCIALIZATION-IMPROVEMENT-PLAN.zh-CN.md` 和 `docs/scenarios/` 已形成主线文档基础。
- `docs/scenarios/scenario-catalog.json` 已提供 8 个场景的机器可读目录。
- `docs/SUBSYSTEM-REFACTOR-CHECKLIST.md` 已把管理层、服务层、应用层、基建层和横切治理的 provider / operation / domain service 边界状态纳入台账。
