...
- Run ID: `20260608T151652Z`
- Generated At: `2026-06-08T15:17:00.476Z`
- Branch: `nightly`
- Commit: `1733b02be2c2847f22f43410382a0b074e9432cf`
- Evidence For Commit: `1733b02be2c2847f22f43410382a0b074e9432cf`
- Dirty Files: `11`
...
| --- | --- | --- | --- | --- | --- |
架构门禁 | pass | P0 | platform-architecture | `docs/reports/history/production-readiness/20260608T151652Z/architecture.log` | 修复架构治理、平台分层或核心文档与实现偏差。
文档解析真实样例 | pass | P0 | knowledge-ingestion | `docs/reports/history/production-readiness/20260608T151652Z/document-parsing-real-sample.log` | 补齐真实文档解析 fixture、结构锚点、动态切分和 DOCX 导出基准。
端到端 UI smoke | pass | P0 | console-frontend | `docs/reports/history/production-readiness/20260608T151652Z/ui-smoke.log` | 补齐控制台生产健康页、关键路由 smoke、前端 feature registry 和页面验收。
