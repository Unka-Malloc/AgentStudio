...
| T12 provider mode、receipt 和 iCloud/OneDrive live | partial | `v001-cloud-drive-e2e` 和 `external-service-api-registration` 单独通过，但没有证明真实 OneDrive OAuth remote-live；iCloud local-live 也未单独 smoke。 | 补 OneDrive live smoke、iCloud local-live smoke，禁止 contract/fake 替代。 |
