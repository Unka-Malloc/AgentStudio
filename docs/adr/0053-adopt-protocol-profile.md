...
Profile entries must stay aligned with implemented package behavior. Future surfaces such as SQLite storage, separate per-workspace queues, repair fact execution, and benchmark baseline enforcement require implementation and ADR updates before they become profile commitments.
