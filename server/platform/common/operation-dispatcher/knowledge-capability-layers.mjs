...
const AGENT_PRODUCTION_OPERATION_IDS = new Set([
  ...
  "knowledge.retrieval_playbook.describe",
  ...
  "knowledge.playbooks.list",
  "knowledge.playbooks.get",
  "knowledge.playbooks.generate",
  "knowledge.playbooks.propose",
  "knowledge.playbooks.resolve",
  "knowledge.skills.deployments.create",
  "knowledge.skills.deployments.rollback",
  "knowledge.playbook_sets.deployments.create",
  "knowledge.playbook_sets.deployments.rollback",
  "knowledge.skills.framework",
  "knowledge.skills.framework_save",
  "knowledge.playbook_framework.get",
  "knowledge.playbook_framework.save",
