...
export const OPERATION_LEDGER_PROTOCOL_VERSION = "v0.1.0:pactium:operation-ledger-1";
...
export function createOperationLedger({ dataDir = "", userDataPath = "" } = {}) {
  const filePath = dbPathFor(dataDir || userDataPath);
