...
async function verifyToolingSurface(files, findings) {
  ...
  const expectedScripts = {
    ...
    "test:coverage": "node --test --experimental-test-coverage '--test-coverage-exclude=bin/**' --test-coverage-exclude=src/http.js --test-coverage-exclude=tests/pactium/failing-storage.js --test-coverage-lines=95 --test-coverage-functions=95 --test-coverage-branches=90 tests/pactium/*.test.mjs",
