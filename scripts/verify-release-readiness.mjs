...
async function verifyToolingSurface(files, findings) {
  ...
  const expectedScripts = {
    ...
    "test:coverage": "node --test --experimental-test-coverage '--test-coverage-exclude=bin/**' --test-coverage-exclude=src/http.js --test-coverage-exclude=src/canonical/safe-value.js --test-coverage-exclude=src/core/append-only-event-log.js --test-coverage-exclude=src/core/content-addressed-store.js --test-coverage-exclude=src/core/state-commit-store.js --test-coverage-exclude=src/storage/data-dir-preflight.js --test-coverage-exclude=tests/pactium/failing-storage.js --test-coverage-exclude=tests/pactium/doctor-coverage.test.mjs --test-coverage-exclude=tests/pactium/host-neutral-helpers.test.mjs --test-coverage-lines=95 --test-coverage-functions=95 --test-coverage-branches=90 tests/pactium/*.test.mjs",
